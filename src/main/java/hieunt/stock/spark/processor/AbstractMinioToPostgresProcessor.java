...
public abstract class AbstractMinioToPostgresProcessor implements BaseProcessor {
    ...
    public AbstractMinioToPostgresProcessor(String type, String tableName, String folderPath, String partitionPath) {
    ...
    public void process() {
        ...
        try {
            ...
            if (df != null && !df.isEmpty()) {
                ...
                // Loại bỏ duplicate theo business key trước khi gán version
                ...
                java.time.format.DateTimeFormatter vFormatter = java.time.format.DateTimeFormatter
                        .ofPattern("yyyyMMddHHmm");
                long batchVersion = Long.parseLong(java.time.LocalDateTime.now().format(vFormatter));

                // Add audit columns
                Dataset<Row> auditData = dedupedData
                ...
                System.out.println("Writing to Postgres table: " + tableName
